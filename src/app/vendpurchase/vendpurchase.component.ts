...
@Component({
  selector: 'app-vendpurchase',
  templateUrl: './vendpurchase.component.html',
  styleUrls: ['./vendpurchase.component.css']
})
export class VendpurchaseComponent implements OnInit {
  ...
  ngOnInit(): any {
    ...
    return this.http.post(this.baseUrl, {
      ...
      response => {
        ...
        this.list = this.Data.IT_ITEM.item;
  ...
  onInvoiceClick(data: any) {
    ...
    if (this.show) {
      this.buttonName = "Back to Quotation";
